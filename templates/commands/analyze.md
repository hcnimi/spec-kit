...
Identify inconsistencies, duplications, ambiguities, and underspecified items across the three core artifacts (`spec.md`, `plan.md`, `tasks.md`) before implementation. This command should run after `/tasks` has produced a complete `tasks.md`.

## Operating Constraints

**STRICTLY READ-ONLY**: Do **not** modify any files. Output a structured analysis report. Offer an optional remediation plan (user must explicitly approve before any follow-up editing commands would be invoked manually).

**Constitution Reference**: The project constitution (`/memory/constitution.md`) provides guiding principles. Constitution conflicts should be flagged for review and adjustment of the spec, plan, or tasks.
...
- Any requirement or plan element conflicting with principles
- Missing sections or quality gates from constitution
...
- **CRITICAL**: Violates constitution principles, missing core spec artifact, or requirement with zero coverage that blocks baseline functionality
